            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <input type="text" name='name' placeholder="your name" defaultValue={user?.displayName} disabled className="input input-bordered w-full mt-6" />
                        <input type="text" name='email' placeholder="your email" defaultValue={user?.email} disabled  className="input input-bordered w-full mt-6" />
